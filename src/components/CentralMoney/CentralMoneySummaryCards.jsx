...
export const CentralMoneySummaryCards = ({ totals }) => {
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-md" style={{ marginBottom: 'var(--spacing-lg)' }}>
      ...
      <div className="bg-card animate-fade-in col-span-2 md:col-span-2 lg:col-span-4" style={{ animationDelay: '0.05s', border: '2.5px solid #db2777', backgroundColor: '#fce7f3' }}>
        <div className="flex justify-between items-center" style={{ marginBottom: 'var(--spacing-sm)' }}>
          <h3 style={{ color: '#db2777', fontSize: '0.875rem', fontWeight: '500' }}>ยอดคงเหลือทั้งหมด</h3>
      ...
      <div className="bg-card animate-fade-in" style={{ animationDelay: '0.1s', border: '1px solid rgba(219, 39, 119, 0.2)' }}>
        <div className="flex justify-between items-center" style={{ marginBottom: 'var(--spacing-sm)' }}>
          <h3 style={{ color: '#db2777', fontWeight: '500', fontSize: '0.875rem' }}>ยอดเรียกทั้งหมด</h3>
          <div style={{ padding: '0.5rem', backgroundColor: '#fdf2f8', borderRadius: 'var(--radius-full)' }}>
      ...
      <div className="bg-card animate-fade-in" style={{ animationDelay: '0.2s', border: '1px solid rgba(22, 163, 74, 0.2)' }}>
        <div className="flex justify-between items-center" style={{ marginBottom: 'var(--spacing-sm)' }}>
          <h3 style={{ color: '#15803d', fontWeight: '500', fontSize: '0.875rem' }}>ยอดเก็บทั้งหมด</h3>
      ...
      <div className="bg-card animate-fade-in" style={{ 
        ...
        <div className="flex justify-between items-center" style={{ marginBottom: 'var(--spacing-sm)' }}>
          <h3 style={{ color: totals.outstanding === 0 ? '#64748b' : '#dc2626', fontSize: '0.875rem', fontWeight: '600' }}>ยอดค้างทั้งหมด</h3>
      ...
      <div className="bg-card animate-fade-in" style={{ animationDelay: '0.5s', border: '1px solid rgba(29, 78, 216, 0.2)' }}>
        <div className="flex justify-between items-center" style={{ marginBottom: 'var(--spacing-sm)' }}>
          <h3 style={{ color: '#1d4ed8', fontWeight: '500', fontSize: '0.875rem' }}>ยอดยืมเงินทั้งหมด</h3>
      ...
      <div className="bg-card animate-fade-in" style={{ animationDelay: '0.6s', border: '1px solid rgba(14, 116, 144, 0.2)' }}>
        <div className="flex justify-between items-center" style={{ marginBottom: 'var(--spacing-sm)' }}>
          <h3 style={{ color: '#0e7490', fontWeight: '500', fontSize: '0.875rem' }}>ยอดคืนเงินทั้งหมด</h3>
      ...
      <div className="bg-card animate-fade-in" style={{ 
        ...
        <div className="flex justify-between items-center" style={{ marginBottom: 'var(--spacing-sm)' }}>
          <h3 style={{ color: totals.outstandingReturn === 0 ? '#64748b' : '#ea580c', fontSize: '0.875rem', fontWeight: '600' }}>ยอดค้างคืนทั้งหมด</h3>
      ...
      <div className="bg-card animate-fade-in" style={{ 
        ...
        <div className="flex justify-between items-center" style={{ marginBottom: 'var(--spacing-sm)' }}>
          <h3 style={{ color: '#6d28d9', fontWeight: '500', fontSize: '0.875rem' }}>ยอดเบิกเงินทั้งหมด</h3>
